...
public class thisbeforethat {
	...
	public static void main(String args[]) {
		...
		final Set<Integer> childNodes = new HashSet<Integer>();
		...
		for (int i = 0; i < n; i++) {
			...
			if (roots.indexOf(parent) == -1 && !childNodes.contains(parent)) {
				roots.add(parent);
			}
		...
		final List<Integer> sorted = new LinkedList<Integer>();
		while (roots.size() > 0) {
